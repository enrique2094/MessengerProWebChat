...
function chatGenerator(index) {
    const names = ["Alejandro Farias", "Maria Tepedino", "Melissa Pino", "Pedro Malave", "Isabel Benavides", "Fernanda Martinez", "Carlos Castillo", "Alejandra Rodriguez", "Sandra Martinez", "Sergio Araujo", "Michelle La Cruz", "Michael Costello", "Samantha Willet", "Ximena Aguin", "Rosa Garcia", "Carmen Marcano", "Maite Delgado", "Nicolas Cabello", "Pete Sariya", "Monty Carlo", "Sal Monella", "Sue Vaneer", "Cliff Hanger", "Barb Dwyer", "Terry Aki", "Cory Ander", "Robin Banks", "Jimmy Changa", "Barry Wine", "Wilma Mumduya", "Buster Hyman", "Poppa Cherry", "Zack Lee", "Don Stairs", "Saul T. Balls", "Peter Pants", "Hal Appeno", "Otto Matic", "Moe Fugga", "Graham Cracker", "Tom Foolery", "Al Dente", "Bud Wiser", "Polly Tech", "Holly Graham", "Frank N. Stein", "Cam L. Toe", "Pat Agonia", "Tara Zona", "Barry Cade"]
